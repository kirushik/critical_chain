...
RSpec.describe EstimationItemsController, :type => :controller do
  ...
  describe "POST create" do
    it "adds an item to the estimation when authorized" do
      ...
      post :create, estimation_id: estimation.id, estimation_item: { title: 'sample', value: 117 }
  ...
  describe "PATCH update" do
    ...
    it 'denies to update quantity to negative numbers' do
      expect do
        xhr :patch, :update, id: estimation_item.id, estimation_id: estimation.id, estimation_item: { quantity: -1 }, format: :js
